...
**Example:**
```bash
✓ Successfully combined 3 PDFs into E:/code/GIT_pythontoys/FixPDFToPrint/output.pdf
```
...
Use `CombinePDFs.py` when you need to:
...
- `CombinePDFs.py` preserves the exact page order specified in the input_files list
